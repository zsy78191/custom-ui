...
#import "CUISystemPurchaseDelegate.h"
@import StoreKit;

@interface CUISystemPurchaseDelegate()
@property (nonatomic, strong) NSArray* products;
@end

@implementation CUISystemPurchaseDelegate

+ (instancetype)sharedOne
{
    static CUISystemPurchaseDelegate* _sh_delegate = nil;
    static dispatch_once_t onceToken;
    dispatch_once(&onceToken, ^{
        _sh_delegate = [[CUISystemPurchaseDelegate alloc] init];
    });
    return _sh_delegate;
}
